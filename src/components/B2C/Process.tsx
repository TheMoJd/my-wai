...
const Process = () => {
  ...
  const steps = t("process_section.steps", { returnObjects: true }) as Array<{
    title: string;
    description: string;
  }>;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="mb-6 w-16 h-16 bg-mywai/5 rounded-2xl flex items-center justify-center group-hover:bg-mywai transition-colors duration-300">
                <div className="text-mywai group-hover:text-white transition-colors duration-300 [&>svg]:fill-current">
                  {stepIcons[index]}
                </div>
              </div>
