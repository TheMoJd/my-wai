          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground">
                {t("footer.contact.email")}: {t("footer.contact.email_value")}
              </li>
              <li className="text-muted-foreground">
                {t("footer.contact.phone")}: {t("footer.contact.phone_value")}
              </li>
              <li className="text-muted-foreground">
            ...
            <div className="flex gap-4 mt-4">
              <a
                href="#"
                className="w-8 h-8 rounded-full bg-mywai/20 flex items-center justify-center text-mywai hover:bg-mywai hover:text-white transition-colors"
              >
                <svg
                  width="16"
                  height="16"
