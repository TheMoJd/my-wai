      ...
      <div className="container mx-auto px-6 sm:px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-tight">
              Racontez <span className="text-mywai">l’histoire</span> de votre <span className="text-mywai">entreprise</span> avec <span className="text-mywai">l’Intelligence Artificielle</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground">
              Offrez à vos collaborateurs un souvenir impérissable pour leur départ ou un moment marquant (5/10/50/100 ans...).<br />
              Transformez archives, témoignages et moments-clés en un récit puissant : un livre d’entreprise coécrit par vos équipes et structuré par l’IA.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start">
              ...
              >
                Demander un devis (à partir de 490€)
              </Button>
              <Button
                variant="outline"
                size="md"
              ...
              >
                Créer une biographie pour un proche
              </Button>
            </div>
          </div>
            ...
            <div className="relative z-10 animate-float">
              ...
              <div className="absolute top-1/4 -left-14 bg-white rounded-lg shadow-lg p-3 transform -rotate-6">
                <div className="h-24 w-28 rounded-md bg-mywai/20 flex items-center justify-center">
                  <img src="/premier-offert.png" alt="Livre entreprise" className="w-full h-full object-cover rounded-md" />
                </div>
              </div>
              <div className="absolute -bottom-10 -right-10 bg-white rounded-lg shadow-lg p-3 transform rotate-12">
                <div className="h-20 w-32 rounded-md bg-mywai/10 flex items-center justify-center">
                  <img src="/envoyer_selfie.png" alt="Illustration" className="w-full h-full object-cover rounded-md" />
                </div>
              </div>
            </div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-md">
            ...
            <h3 className="text-xl font-display font-bold mb-2">Sur-mesure & authentique</h3>
            <p className="text-muted-foreground">Un récit fidèle et structuré qui reflète l’ADN et l’impact de votre entreprise.</p>
          </div>
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-md">
            <div className="w-16 h-16 mx-auto mb-4 bg-mywai/10 rounded-full flex items-center justify-center">
              <svg viewBox="0 0 24 24" className="h-8 w-8 fill-mywai">
            ...
            <h3 className="text-xl font-display font-bold mb-2">Coécriture facilitée</h3>
            <p className="text-muted-foreground">Vos équipes, clients et partenaires contribuent simplement via un espace dédié.</p>
          </div>
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-md">
            <div className="w-16 h-16 mx-auto mb-4 bg-mywai/10 rounded-full flex items-center justify-center">
              <svg viewBox="0 0 24 24" className="h-8 w-8 fill-mywai">
            ...
            <h3 className="text-xl font-display font-bold mb-2">Patrimoine durable</h3>
            <p className="text-muted-foreground">Un support élégant qui transmet histoire, valeurs et vision aux générations futures.</p>
          </div>
        </div>
      </div>
    </section>
