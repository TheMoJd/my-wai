  ...
  return (
    <section className="section-padding bg-cream" id="contact-b2b">
      <div className="container mx-auto px-4">
        ...
        <p className="section-subtitle max-w-2xl mx-auto">{t('b2b.contact.subtitle')}</p>
        <div className="max-w-3xl mx-auto mt-10 bg-white/80 backdrop-blur rounded-3xl p-8 md:p-10 ring-1 ring-mywai/15">
          {submitted ? (
            <div className="text-center">
              <h3 className="text-2xl font-display font-bold mb-4 text-mywai">{t('b2b.contact.thank_you')}</h3>
              <p className="text-muted-foreground">{t('b2b.contact.thank_you_msg')}</p>
            </div>
          ) : (
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium mb-2">{t('b2b.contact.fields.name')}</label>
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">{t('b2b.contact.fields.email')}</label>
              ...
              <div>
                <label className="block text-sm font-medium mb-2">{t('b2b.contact.fields.company')}</label>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium mb-2">{t('b2b.contact.fields.website')}</label>
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">{t('b2b.contact.fields.phone')}</label>
              ...
              <div>
                <label className="block text-sm font-medium mb-2">{t('b2b.contact.fields.message')}</label>
